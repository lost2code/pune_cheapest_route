...
import java.io.*;
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			g.addVertex("Nigdi~B");
			g.addVertex("Bhosari~B");
			g.addVertex("Pimpri~B");
			g.addVertex("Khotrud~BY");
			g.addVertex("Shivaji Nagar~B");
			g.addVertex("Pune station~B");
			g.addVertex("Hadapsur~BO");
			g.addVertex("Swargate~B");
			g.addVertex("Market yard~Y");
			g.addVertex("Dighi~Y");
			g.addVertex("Khadki~Y");
			g.addVertex("Airport~Y");
			g.addVertex("Warje~YO");
			g.addVertex("Vishrantwadi~Y");
			g.addVertex("Alandi~O");
			g.addVertex("PMC~O");
			g.addVertex("Deccan~O");
			g.addVertex("Sangvi~BP");
			g.addVertex("Chinchwad~PR");
			g.addVertex("Chikli~P");
			
			g.addEdge("Nigdi~B", "Bhosari~B", 15);
			g.addEdge("Bhosari~B", "Pimpri~B", 06);
			g.addEdge("Pimpri~B", "Shivaji Nagar~B", 8);
			g.addEdge("Pimpri~B", "Khotrud~BY", 21);
			g.addEdge("Khotrud~BY", "Pune station~B", 14);
			g.addEdge("Pune station~B", "Hadapsur~BO", 07);
			g.addEdge("Hadapsur~BO", "Swargate~B", 8);
			g.addEdge("Market yard~Y", "Dighi~Y", 19);
			g.addEdge("Dighi~Y", "Vishrantwadi~Y", 6);
			g.addEdge("Vishrantwadi~Y", "Khotrud~BY", 16);
			g.addEdge("Khotrud~BY", "Warje~YO", 3);
			g.addEdge("Warje~YO", "Airport~Y", 11);
			g.addEdge("Airport~Y", "Khadki~Y", 5);
			g.addEdge("Warje~YO", "Alandi~O", 24);
			g.addEdge("Alandi~O", "PMC~O", 20);
			g.addEdge("PMC~O", "Deccan~O", 2);
			g.addEdge("Pune station~B", "Sangvi~BP", 9);
			g.addEdge("Chikli~P", "Sangvi~BP", 5);
			g.addEdge("Chikli~P", "Chinchwad~PR", 4);
		}
